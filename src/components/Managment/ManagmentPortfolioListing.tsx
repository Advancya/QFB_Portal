...
interface iManagmentPortfolioListing {
  showManagmentPortfolioListingModal: boolean;
  hideManagmentPortfolioListingModal: () => void;
  showManagmentDetailsModal: () => void;
  showNewBeneficiaryModal: () => void;
  backManagmentPortfolioListingModal: () => void;
}
function ManagmentPortfolioListing(
  managmentPortfolioListingProps: iManagmentPortfolioListing
) {
  ...
  const showMoreManagmentPortfolioListing = () => {
      ...
      <div className="border-bottom p-3">
        <div className="row align-items-center">
          <div className="col-md-6 col-lg-7">
            <h3>{local_Strings.ManagementLandingItem2Title}</h3>
          </div>
...
export default ManagmentPortfolioListing;
