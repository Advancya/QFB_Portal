    ...
    >
      ...
      <Modal.Body>
        ...
        <TransactionListing transactions={filteredData}
          showBalanceField={false} descriptionLabel={local_Strings.RequestTypeLabel} />
        ...
        {filteredData && filteredData.length > 0 && !!filteredData[0].accountNumber &&
          <div className="exportExcel">
            <ExcelFile filename={props.facilityNumber + " " +
              ...
              <ExcelSheet data={filteredData} name={local_Strings.HistoricalPaymentsText}>
                <ExcelColumn label={local_Strings.AccountNo} value="ourReference" />
                ...
                <ExcelColumn label={local_Strings.RequestTypeLabel} value={"trxDescirption"} />
              </ExcelSheet>
            </ExcelFile>
          </div>}
      </Modal.Body>
