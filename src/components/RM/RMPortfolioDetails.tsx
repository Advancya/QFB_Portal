...
interface iRMPortfolioDetails {
  ...
  hideRMPortfolioDetailsModal: () => void;
  backRMPortfolioDetailsgModal: () => void;
  showNewBeneficiaryModal: () => void;
}
function RMPortfolioDetails(rMPortfolioDetailsProps: iRMPortfolioDetails) {
  return (
    <Modal
      ...
      <Modal.Header>
        <div className="d-flex align-items-center">
          <div className="modal-header-text">
            <a
              href="#"
              onClick={rMPortfolioDetailsProps.backRMPortfolioDetailsgModal}
...
export default RMPortfolioDetails;
